  ...
  <div class="mx-auto max-w-5xl px-6 py-8">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
      <div
        ...
        :key="p.id"
        class="group relative rounded-lg border border-neutral-200 bg-white p-4 text-left transition hover:border-orange-300 hover:shadow-sm"
      >
        <button
          type="button"
        ...
        >
          <div class="flex items-center justify-between">
            <div
              ...
              :class="p.color ? '' : 'bg-orange-50 text-orange-700'"
            >
          ...
          <div v-if="p.description" class="mt-1 line-clamp-2 text-xs text-neutral-600">{{ p.description }}</div>
        ...
        <div class="absolute right-2 top-2">
          <button
            type="button"
            class="rounded-md p-1 text-neutral-400 opacity-0 transition group-hover:opacity-100 hover:bg-neutral-100 hover:text-neutral-700"
            :class="{ 'opacity-100 bg-neutral-100 text-neutral-700': openMenuFor === p.id }"
          ...
          <div
            ...
            class="absolute right-0 z-10 mt-1 w-36 rounded-md border border-neutral-200 bg-white py-1 shadow-md"
            @click.stop
          >
            <button
              type="button"
            ...
            <button
              type="button"
              class="block w-full px-3 py-1.5 text-left text-xs text-orange-700 hover:bg-orange-50"
      ...
      <div class="w-full max-w-lg rounded-xl bg-white shadow-xl">
        <header class="flex items-center justify-between border-b border-neutral-100 px-5 py-3">
          <div>
            ...
            <div class="mt-0.5 font-mono text-[11px] text-neutral-400">{{ editing.id }}</div>
          </div>
          <button
            type="button"
        ...
        <form class="space-y-3 px-5 py-4" @submit.prevent="save">
          ...
          <div class="grid grid-cols-2 gap-3">
            <label class="block">
              <span class="block text-xs font-medium text-neutral-600">Icon</span>
              <input
                v-model="form.icon"
                type="text"
                maxlength="4"
          ...
          <div class="-mx-5 mt-2 border-t border-neutral-100"></div>

          <div class="rounded-md border border-red-200 bg-red-50 p-3">
            <div class="text-xs font-medium text-red-900">Danger zone</div>
            <p class="mt-1 text-[11px] text-red-800">
            ...
            <button
              type="button"
              :disabled="!canDelete"
              class="mt-2 rounded-md border border-red-300 bg-white px-3 py-1.5 text-xs text-red-700 hover:bg-red-100 disabled:opacity-50"
